...
static struct sockaddr_in6 unique_local_addr = {
	...
	// 192.168.0.125:
	//.sin6_addr.s6_addr = {0xfd, 0x29, 0x15, 0xb9, 0xc1, 0x16, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0xc0, 0xa8, 0x00, 0x7d},
	// Coap.me:
	.sin6_addr.s6_addr = {0xfd, 0x29, 0x15, 0xb9, 0xc1, 0x16, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x86, 0x66, 0xda, 0x12},
	// This (coap.me) does not work:
    //.sin6_addr.s6_addr = {0x00, 0x64, 0xff, 0x9b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x86, 0x66, 0xda, 0x12},
	.sin6_scope_id = 0U
};

static const char *const coap_option[] = { "time", 0 };
